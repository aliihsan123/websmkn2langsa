...
<body>
  ...
  <div class="container" style="margin-top: 30px; background-color: white; padding: 15px 15px 15px 15px;">
  	...
  	<div class="kanan">
  		<h2>Struktur LSP SMKN 2 LANGSA</h2>

      <img src="../images/strukturLSP.png" width="100%">
  	</div>
  	<div class="clear"></div>	
  </div><br>
