...
<div class="container" style="margin-top: 50px;">
	<div class="card">
	  	<h5 class="card-header">Konten Terbaru</h5>
	  	<div class="card-body">
		    <form method="post" action="" enctype="multipart/form-data">
		    	<p class="card-text">
		    		<input type="text" name="judul" placeholder="Judul konten" class="container"><br><br>
		    		<input type="text" name="nama" placeholder="Isi konten" class="container"><br><br>
		    ...
		    <?php 
				...
				if (isset($_POST['simpan'])){
					...
					$insert = mysqli_query($koneksi, "INSERT INTO tbl_konten_terbaru VALUES (NULL,'".$_POST['judul']."','".$_POST['nama']."','".$rename."','tidak aktif',NULL)");
					if ($insert) {
			    	...
			    	<div class="media">
					    ...
					    <div class="card-body">
					    	<h5 class="card-title"><?php echo $hasil['judul']; ?></h5>
					      	...
					      	<a class="btn btn-primary" href="hapus_konten.php?id=<?php echo $hasil['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus foto ini ?')">Hapus Konten</a>
					    </div>
					</div>
...
<div class="container" style="margin-top: 50px;">
	<div class="card">
	  	<h5 class="card-header">Aktifkan Konten Terbaru</h5>
	  	<div class="card-body">
	  		<p>
		    	...
		    	<table class="table table-striped table-light">
		    		...
		    		<?php  
				    	include "../koneksi.php";
				    	$sql = mysqli_query($koneksi, "SELECT * from tbl_konten_terbaru");
				    	$no=1;
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<a href="aktifkonten.php?id=<?php echo $data['id']; ?>">Aktif |</a>
		    				<a href="nonaktifkonten.php?id=<?php echo $data['id']; ?>">Nonaktif</a>
		    			</td>
		    		</tr>
		    		<?php $no++; } ?>
		    	</table>
