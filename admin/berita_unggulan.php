...
<div class="container" style="margin-top: 50px;">
	<div class="card">
	  	<h5 class="card-header">Berita Unguulan</h5>
	  	<div class="card-body">
		    ...
		    <?php 
				...
				if (isset($_POST['simpan'])){
					...
					$insert = mysqli_query($koneksi, "INSERT INTO tbl_beritaunggulan VALUES (NULL,'".$_POST['judul']."','".$_POST['nama']."','".$rename."','tidak aktif',NULL)");
					if ($insert) {
			...
			<hr><br>
			<?php
				$produk =mysqli_query($koneksi, "SELECT * FROM tbl_beritaunggulan");
			    ...
			    <div class="media">
					    ...
					    <div class="card-body">
					    	<h5 class="card-title"><?php echo $hasil['judul']; ?></h5>
					      	...
					      	<a class="btn btn-primary" href="hapus_berita.php?id=<?php echo $hasil['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus foto ini ?')">Hapus Berita</a>
					    </div>
					</div>
...
<div class="container" style="margin-top: 50px;">
	<div class="card">
	  	<h5 class="card-header">Aktifkan Berita Unguulan</h5>
	  	<div class="card-body">
	  		<p>
		    	...
		    	<table class="table table-striped table-light">
		    		...
		    		<?php  
				    	include "../koneksi.php";
				    	$sql = mysqli_query($koneksi, "SELECT * from tbl_beritaunggulan");
				    	$no=1;
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<a href="aktifberita.php?id=<?php echo $data['id']; ?>">Aktif |</a>
		    				<a href="nonaktifberita.php?id=<?php echo $data['id']; ?>">Nonaktif</a>
		    			</td>
		    		</tr>
		    		<?php $no++; } ?>
		    	</table>
