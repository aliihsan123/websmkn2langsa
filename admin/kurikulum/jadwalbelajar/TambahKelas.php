...
<body>
    ...
    <div class="container-fluid p-3 mb-2 bg-light text-white">
        <div class="col-12 p-3 mb-2 bg-white text-dark">
            <h3 class="text-primary">Tambah Kelas</h3>
            ...
            <div>
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="kd_kelas" placeholder="Kode Kelas" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <a href="DataKelas.php" class="btn btn-danger">Kembali</a>
                        </div>
                    </div>
                </form>
                <?php  
                    ...
                    if($_SERVER['REQUEST_METHOD']=='POST'){
                        ...
                        if($kd_kelas == '' || $nama_kelas == '' || $kapasitas == ''){
                            echo "Form belum lengkap";
                        }else{
                            $sql = mysqli_query($koneksi, "SELECT * from kelas where nm_kelas='$nama_kelas'");

                            if(mysqli_num_rows($sql) > 0){
                                echo "Nama Kelas Sudah Ada";
                            }else{
                                $simpan = mysqli_query($koneksi, "INSERT into kelas values('$kd_kelas','$nama_kelas','$kapasitas')");
                                if($simpan){
