...
<body>
    ...
    <div class="container-fluid p-3 mb-2 bg-light text-white">
        <div class="col-12 p-3 mb-2 bg-white text-dark">
            <div class="row">
                <div class="col-6">
                    <h3 class="text-primary">Data Kelas</h1>
                </div>
                <div class="col6">
                    <a href="TambahKelas.php" class="btn btn-success">Tambah Kelas</a>
                </div>
            </div><br>
            ...
            <div>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="EditKelas.php?kd=<?php echo $data['kd_kelas']; ?>">Update |</a>
                            <a href="HapusKelas.php?kd=<?php echo $data['kd_kelas']; ?>"> Hapus</a>
                        </td>
                    </tr>
                    <?php $no++; } ?>                  
                </table>
