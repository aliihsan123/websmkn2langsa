...
<div class="container-fluid" style="background-color: #1E90FF; padding-top: 1.2%; padding-bottom: 1.2%;">
	<div class="container">
		<a class="navbar-brand" id="index" href="galery.php"><i>Galery Foto SMK Negeri 2 Langsa</i></a>
...
<div class="container-fluid" style="background-color: white; padding-top: .6%; padding-bottom: .6%;">
	<div class="container">
		<ol style="list-style: none; margin: 0; padding:0;">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Galery Foto</li>
		</ol>
	</div>
</div>
