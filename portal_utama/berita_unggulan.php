...
<div class="container-fluid" style="background-color: #CD5C5C; padding-top: 1.2%; padding-bottom: 1.2%;">
	<div class="container">
		<a class="navbar-brand" id="index" href="berita_unggulan.php"><i>Berita Unggulan</i></a>
...
<div class="container-fluid" style="background-color: white; padding-top: .6%; padding-bottom: .6%;">
	<div class="container">
		<ol style="list-style: none; margin: 0; padding:0;">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Berita Unggulan</li>
		</ol>
	</div>
</div>
